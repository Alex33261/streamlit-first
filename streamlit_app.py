...
st.write('Vas aussi voir les liens dans la partie de Souliman qui pourraient t interesser.')
...
st.markdown("- TechniScent")
st.write("Mettre la nouvelle UI avec Souliman")

st.markdown("- Projet avec La Plateforme")
st.write("Caler un rendez-vous Deborah. J ai deux projets en tete pour elle incluant la propriete intellectuelle : un chatbot et un outil de resume de brevets.")
